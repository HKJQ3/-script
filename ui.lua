...
writefile("image",game:HttpGet(ImageOpen))
Open.Parent = Frame
...
Open.Active = true
Open.Draggable = true
Open.Image = getcustomasset("image",true)
Open.MouseButton1Click:Connect(function()
  Main.Visible = not Main.Visible
  Open.Image = Main.Visible and getcustomasset("image",true) or getcustomasset("image",true) --开关的图
end)
