...
local win1 = library:CreateTab("关于")

win1:NewButton("加入木材服务器", function()--演示
    game:GetService("TeleportService"):Teleport(13822889)
end)

win1:NewButton("#感谢#你的支持就是我最大的动力", function()--演示
    print("Thx for used");
end)

win1:NewButton("当前版本:1.0正式免费版", function()--演示
    print("1.0");
end)

win1:NewButton("购买付费联系你的小天使--Admin", function()--演示
    print("+");
end)

win1:NewButton("付费版作者QQ号3585189460", function()--演示
    print("+");
end)

win1:NewButton("脚本功能较少以后更新,更多功能", function()--演示
    print("+");
end)

local win1 = library:CreateTab("通用");

win1:NewSeparator()
-- 创建一个空白区域

win1:NewButton("键盘", function()--演示
    loadstring(game:HttpGet("https://raw.githubusercontent.com/advxzivhsjjdhxhsidifvsh/mobkeyboard/main/main.txt", true))()
end)

win1:NewButton("飞行", function()--演示
...
local win1 = library:CreateTab("主要功能");

win1:NewButton("加载免费版(程序1)", function()--演示
    loadstring(game:HttpGet(('https://raw.githubusercontent.com/HKJQ3/-script/refs/heads/main/%E5%A4%A7%E9%97%B9%E5%A4%A9%E5%AE%AB.lua'),true))()
end)

win1:NewButton("加载免费版(程序2)", function()--演示
    loadstring(game:HttpGet(('https://raw.githubusercontent.com/HKJQ3/-script/refs/heads/main/卡'),true))()
end)

end)if not s then notify("Error:"..r)end